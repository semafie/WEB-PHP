...
else {echo "Maaf ini belum masuk puasa <br>"; };
echo "ini contoh switch <br>";
switch($nilai) {
    case 100 :echo "Nilai yang di pilih 100 <br>";
    break;
    case 90 :echo "Nilai yang dipilih adalah 90 <br>";
    break;
}echo "Contoh For <br>";
for($i=1;$i<=5;$i++){
    echo "for looping ke :" .$i."<br>";
}
...
// break;
// } echo "CONTOH FOR <br>";
// for($i=1;$i<=5;$i++) {echo "Looping FOR ke : ".$i."<br>";
// }
// echo "CONTOH WHILE <br>";
// $j=1;
// while($j<=5) {
